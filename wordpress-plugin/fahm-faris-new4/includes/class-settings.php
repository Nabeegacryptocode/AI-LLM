...
class Fahm_Faris_Settings {
    ...
    public static function register_settings() {
        ...
        register_setting('fahm_faris_settings', 'fahm_faris_widget_title', array(
            'type' => 'string',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => __('Chat with Faris', 'fahm-faris')
        ));
        
        register_setting('fahm_faris_settings', 'fahm_faris_placeholder', array(
            'type' => 'string',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => __('Ask me anything about FAHM...', 'fahm-faris')
        ));
    ...
    public static function render_widget_title_field() {
        $value = get_option('fahm_faris_widget_title', __('Chat with Faris', 'fahm-faris'));
        ?>
        <input type="text"
    ...
    public static function render_placeholder_field() {
        $value = get_option('fahm_faris_placeholder', __('Ask me anything about FAHM...', 'fahm-faris'));
        ?>
        <input type="text" 
