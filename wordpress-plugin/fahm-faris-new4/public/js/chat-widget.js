(function($) {
    ...
    class FahmFarisChat {
        ...
        bindEvents() {
            ...
            // Close prompt bubble - use event delegation
            $(document).on('click', '#fahm-faris-prompt-close, .prompt-close', (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.dismissPrompt();
            });
            ...
            $(document).on('click', '.prompt-bubble', (e) => {
                // Don't trigger if clicking the close button
                if (!$(e.target).hasClass('prompt-close') && !$(e.target).closest('.prompt-close').length) {
                    this.toggleChat();
                    this.dismissPrompt();
                }
            });
        ...
        minimizeChat() {
            $('#fahm-faris-chat-container').removeClass('active');
